...
public class GameOverUI : EventReceiverInstance
{
    ...
    public void TogglePanel()
    {
        ...
        {
            this.FadeFromTransparent( resultsPanelRef, panelFadeTimeSec );
        ...
        {
            this.FadeToTransparent( resultsPanelRef, panelFadeTimeSec, disableObjectOnFinish: true );
            this.InterpolatePosition( resultsPanelRef.transform, new Vector3( panelInterpXOffset, 0.0f, 0.0f ), panelInterpTimeSec / 2.0f, true );
        }
    }
